...
nnoremap <buffer> <silent><leader>zs :find %:s/\(\.\)\@<=\(\(component\)\(\.w+\)\?\)\(\.\)\@=/service/:s/\(\.\)\@<=\(\(controller\)\(\.w+\)\?\)\(\.\)\@=/service/:s/\(\.\)\@<=\(\(service\)\(\.w+\)\?\)\(\.\)\@=/service/:s/\(\.\)\@<=\(\(entity\)\(\.w+\)\?\)\(\.\)\@=/service/:s/\(\.\)\@<=\(\(repository\)\(\.w+\)\?\)\(\.\)\@=/service/<CR><CR>
